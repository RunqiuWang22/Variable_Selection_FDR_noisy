...
GMUS = new.null(stat="GMUS",name="p")$sumselect1[,2]
GDS = new.null(stat="GDS",name="p")$sumselect1[,2]
CocoLasso = new.null(stat="CocoLasso",name="p")$sumselect1[,2]
...
GMUS = new.null(stat="GMUS",name="aq")$sumselect1[,2]
GDS = new.null(stat="GDS",name="aq")$sumselect1[,2]
CocoLasso = new.null(stat="CocoLasso",name="aq")$sumselect1[,2]
RF = new.null(stat="RF",name="aq")$sumselect1[,2]
result_breast_aq = cbind(Lasso,Lasso_Order,GMUS,GDS,CocoLasso,RF)
colnames(result_breast_aq) = c("Lasso","Lasso_Order","GMUS","GDS", "CocoLasso","RF")
