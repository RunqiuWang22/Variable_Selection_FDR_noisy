...
write.csv(result_breast_p,"result/result_breast_p.csv")
...
result_Colore_p = cbind(Lasso,Lasso_Order,GMUS,GDS,CocoLasso,RF)
colnames(result_Colore_p) = c("Lasso","Lasso_Order","GMUS","GDS", "CocoLasso","RF")
write.csv(result_Colore_p,"result/result_Colore_p.csv")
...
result_breast_p = cbind(Lasso,Lasso_Order,GMUS,GDS,CocoLasso,RF)
colnames(result_breast_p) = c("Lasso","Lasso_Order","GMUS","GDS", "CocoLasso","RF")
write.csv(result_breast_p,"result/result_breast_p_match.csv")
...
result_Colore_p = cbind(Lasso,Lasso_Order,GMUS,GDS,CocoLasso,RF)
colnames(result_Colore_p) = c("Lasso","Lasso_Order","GMUS","GDS", "CocoLasso","RF")
write.csv(result_Colore_p,"result/result_Colore_p_match.csv")
