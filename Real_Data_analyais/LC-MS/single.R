...
whole = function(ZZ,stat,cancer,name){
  ...
  File1 = sprintf("final_breast_%s.csv",name)
  read=read.csv(File1,header=T)
  ...
  for (m in 1:20){
    i=(m-1)*5
    File2 = sprintf("result/%s_%s_%s_%d.csv",ZZ,stat,cancer,i)
...
#xx=whole(ZZ="Z",stat="Lasso",cancer="pbAC",name="p")
...
GMUS = new(stat="GMUS",name="p",cancer="pbAC")$sumselect1[,2]
GDS = new(stat="GDS",name="p",cancer="pbAC")$sumselect1[,2]
CocoLasso = new(stat="CocoLasso",name="p",cancer="pbAC")$sumselect1[,2]
RF = new(stat="RF",name="p",cancer="pbAC")$sumselect1[,2]
result_breast_p = cbind(Lasso,Lasso_Order,GMUS,GDS,CocoLasso,RF)
colnames(result_breast_p) = c("Lasso","Lasso_Order","GMUS","GDS", "CocoLasso","RF")
write.csv(result_breast_p,"result/new/result_breast_p.csv")

Lasso = new(stat="Lasso",name="aq",cancer="aqbAC")$sumselect1[,2]
Lasso_Order = new(stat="Lasso_Order",name="aq",cancer="aqbAC")$sumselect1[,2]
GMUS = new(stat="GMUS",name="aq",cancer="aqbAC")$sumselect1[,2]
GDS = new(stat="GDS",name="aq",cancer="aqbAC")$sumselect1[,2]
CocoLasso = new(stat="CocoLasso",name="aq",cancer="aqbAC")$sumselect1[,2]
RF = new(stat="RF",name="aq",cancer="aqbAC")$sumselect1[,2]
result_breast_p = cbind(Lasso,Lasso_Order,GMUS,GDS,CocoLasso,RF)
colnames(result_breast_p) = c("Lasso","Lasso_Order","GMUS","GDS", "CocoLasso","RF")
write.csv(result_breast_p,"result/new/result_breast_aq.csv")

Lasso = new(stat="Lasso",name="p",cancer="pcAC")$sumselect1[,2]
Lasso_Order = new(stat="Lasso_Order",name="p",cancer="pcAC")$sumselect1[,2]
GMUS = new(stat="GMUS",name="p",cancer="pcAC")$sumselect1[,2]
GDS = new(stat="GDS",name="p",cancer="pcAC")$sumselect1[,2]
CocoLasso = new(stat="CocoLasso",name="p",cancer="pcAC")$sumselect1[,2]
RF = new(stat="RF",name="p",cancer="pcAC")$sumselect1[,2]
result_breast_p = cbind(Lasso,Lasso_Order,GMUS,GDS,CocoLasso,RF)
colnames(result_breast_p) = c("Lasso","Lasso_Order","GMUS","GDS", "CocoLasso","RF")
write.csv(result_breast_p,"result/new/result_corole_p.csv")

Lasso = new(stat="Lasso",name="aq",cancer="aqcAC")$sumselect1[,2]
Lasso_Order = new(stat="Lasso_Order",name="aq",cancer="aqcAC")$sumselect1[,2]
GMUS = new(stat="GMUS",name="aq",cancer="aqcAC")$sumselect1[,2]
GDS = new(stat="GDS",name="aq",cancer="aqcAC")$sumselect1[,2]
CocoLasso = new(stat="CocoLasso",name="aq",cancer="aqcAC")$sumselect1[,2]
RF = new(stat="RF",name="aq",cancer="aqcAC")$sumselect1[,2]
result_breast_p = cbind(Lasso,Lasso_Order,GMUS,GDS,CocoLasso,RF)
colnames(result_breast_p) = c("Lasso","Lasso_Order","GMUS","GDS", "CocoLasso","RF")
write.csv(result_breast_p,"result/new/result_corole_aq.csv")


Lasso = new(stat="Lasso",name="p",cancer="pb")$sumselect1[,2]
Lasso_Order = new(stat="Lasso_Order",name="p",cancer="pb")$sumselect1[,2]
GMUS = new(stat="GMUS",name="p",cancer="pb")$sumselect1[,2]
GDS = new(stat="GDS",name="p",cancer="pb")$sumselect1[,2]
CocoLasso = new(stat="CocoLasso",name="p",cancer="pb")$sumselect1[,2]
RF = new(stat="RF",name="p",cancer="pb")$sumselect1[,2]
result_breast_p = cbind(Lasso,Lasso_Order,GMUS,GDS,CocoLasso,RF)
colnames(result_breast_p) = c("Lasso","Lasso_Order","GMUS","GDS", "CocoLasso","RF")
write.csv(result_breast_p,"result_breast_p.csv")

Lasso = new(stat="Lasso",name="aq",cancer="aqb")$sumselect1[,2]
Lasso_Order = new(stat="Lasso_Order",name="aq",cancer="aqb")$sumselect1[,2]
GMUS = new(stat="GMUS",name="aq",cancer="aqb")$sumselect1[,2]
GDS = new(stat="GDS",name="aq",cancer="aqb")$sumselect1[,2]
CocoLasso = new(stat="CocoLasso",name="aq",cancer="aqb")$sumselect1[,2]
RF = new(stat="RF",name="aq",cancer="aqb")$sumselect1[,2]
result_breast_p = cbind(Lasso,Lasso_Order,GMUS,GDS,CocoLasso,RF)
colnames(result_breast_p) = c("Lasso","Lasso_Order","GMUS","GDS", "CocoLasso","RF")
write.csv(result_breast_p,"result_breast_aq.csv")

Lasso = new(stat="Lasso",name="p",cancer="pc")$sumselect1[,2]
Lasso_Order = new(stat="Lasso_Order",name="p",cancer="pc")$sumselect1[,2]
GMUS = new(stat="GMUS",name="p",cancer="pc")$sumselect1[,2]
GDS = new(stat="GDS",name="p",cancer="pc")$sumselect1[,2]
CocoLasso = new(stat="CocoLasso",name="p",cancer="pc")$sumselect1[,2]
RF = new(stat="RF",name="p",cancer="pc")$sumselect1[,2]
result_breast_p = cbind(Lasso,Lasso_Order,GMUS,GDS,CocoLasso,RF)
colnames(result_breast_p) = c("Lasso","Lasso_Order","GMUS","GDS", "CocoLasso","RF")
write.csv(result_breast_p,"result_corole_p.csv")

Lasso = new(stat="Lasso",name="aq",cancer="aqc")$sumselect1[,2]
Lasso_Order = new(stat="Lasso_Order",name="aq",cancer="aqc")$sumselect1[,2]
GMUS = new(stat="GMUS",name="aq",cancer="aqc")$sumselect1[,2]
GDS = new(stat="GDS",name="aq",cancer="aqc")$sumselect1[,2]
CocoLasso = new(stat="CocoLasso",name="aq",cancer="aqc")$sumselect1[,2]
RF = new(stat="RF",name="aq",cancer="aqc")$sumselect1[,2]
result_breast_p = cbind(Lasso,Lasso_Order,GMUS,GDS,CocoLasso,RF)
colnames(result_breast_p) = c("Lasso","Lasso_Order","GMUS","GDS", "CocoLasso","RF")
write.csv(result_breast_p,"result_corole_aq.csv")