...
real(data=final_brease_p,method="CocoLasso2",Sigmax=as.matrix(bdiag(Sigma_e_p,Sigma_e_p)),deltax=NULL,name='pb')
### colore cancer
...
real(data=final_Colore_p,method="CocoLasso2",Sigmax=as.matrix(bdiag(Sigma_e_p,Sigma_e_p)),deltax=NULL,name='pc')
...
real(data=final_brease_p_AC,method="CocoLasso2",Sigmax=as.matrix(bdiag(Sigma_e_p,Sigma_e_p)),deltax=NULL,name='pbAC')
