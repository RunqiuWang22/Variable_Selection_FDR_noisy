...
#CocoLasso2 = new(stat="CocoLasso2",name="p",cancer="pbAC")$sumselect1[,2]
...
#GMUL = new(stat="GMUL",name="aq",cancer="aqbAC")$sumselect1[,2]
#GDS = new(stat="GDS",name="aq",cancer="aqbAC")$sumselect1[,2]
#CocoLasso2 = new(stat="CocoLasso2",name="aq",cancer="aqbAC")$sumselect1[,2]
...
#CocoLasso2 = new(stat="CocoLasso2",name="p",cancer="pcAC")$sumselect1[,2]
...
#GMUL = new(stat="GMUL",name="aq",cancer="aqcAC")$sumselect1[,2]
#GDS = new(stat="GDS",name="aq",cancer="aqcAC")$sumselect1[,2]
#CocoLasso2 = new(stat="CocoLasso2",name="aq",cancer="aqcAC")$sumselect1[,2]
...
CocoLasso2 = new(stat="CocoLasso2",name="p",cancer="pb")$sumselect1[,2]
...
GMUL = new(stat="GMUL",name="aq",cancer="aqb")$sumselect1[,2]
GDS = new(stat="GDS",name="aq",cancer="aqb")$sumselect1[,2]
CocoLasso2 = new(stat="CocoLasso2",name="aq",cancer="aqb")$sumselect1[,2]
...
CocoLasso2 = new(stat="CocoLasso2",name="p",cancer="pc")$sumselect1[,2]
...
GMUL = new(stat="GMUL",name="aq",cancer="aqc")$sumselect1[,2]
GDS = new(stat="GDS",name="aq",cancer="aqc")$sumselect1[,2]
CocoLasso2 = new(stat="CocoLasso2",name="aq",cancer="aqc")$sumselect1[,2]
