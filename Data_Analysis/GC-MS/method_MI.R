...
final_brease_p=read.csv("final_breast_match_GCMS.csv",header=T)
final_Colore_p=read.csv("final_Colore_match_GCMS.csv",header=T)
final_brease_p_AC=read.csv("final_breast_GCMS.csv",header=T)
final_Colore_p_AC=read.csv("final_Colore_GCMS.csv",header=T)

Sigma_e=read.csv("Sigma_e1.csv",header=T)
Sigma_e2=read.csv("Sigma_e2.csv",header=T)
...
Sigma_e2e=as.matrix(Sigma_e2[,-1])

Sigma_ee=cbind(rbind(Sigma_e,Sigma_e),rbind(Sigma_e,Sigma_e))
Sigma_e2ee=cbind(rbind(Sigma_e2e,Sigma_e2e),rbind(Sigma_e2e,Sigma_e2e))
...
real=function(data, method,Sigmax,deltax,name){
  ...
  for (k in 1:rep){
    ...
    seed[k]=iniseed+k
    set.seed(seed[k])
    select[[k]]=myest_mi(data=data,q=c(0.1,0.2),method="Second",stat=method,flip="Diff",family="binomial",Sigma=Sigmax,delta=deltax,offset=c(0,1))
    
    Z[(m*k-m+1):(m*k),] <- select[[k]]$Zmat
    Ztilde[(m*k-m+1):(m*k),] <- select[[k]]$Ztildemat
...
real(data=final_brease_p,method="CocoLasso",Sigmax=Sigma_ee,deltax=NULL,name='pb')   #study 1
real(data=final_brease_p,method="CocoLasso2",Sigmax=Sigma_e2ee,deltax=NULL,name='pb') #interior QC data
real(data=final_brease_p,method="CocoLasso3",Sigmax=as.matrix(bdiag(Sigma_e,Sigma_e)),deltax=NULL,name='pb')   #study 1
real(data=final_brease_p,method="CocoLasso4",Sigmax=as.matrix(bdiag(Sigma_e2e,Sigma_e2e)),deltax=NULL,name='pb') #interior QC data
...
real(data=final_Colore_p,method="CocoLasso",Sigmax=Sigma_ee,deltax=NULL,name='pc')   #study 1
real(data=final_Colore_p,method="CocoLasso2",Sigmax=Sigma_e2ee,deltax=NULL,name='pc') #interior QC data
real(data=final_Colore_p,method="CocoLasso3",Sigmax=as.matrix(bdiag(Sigma_e,Sigma_e)),deltax=NULL,name='pc')   #study 1
real(data=final_Colore_p,method="CocoLasso4",Sigmax=as.matrix(bdiag(Sigma_e2e,Sigma_e2e)),deltax=NULL,name='pc') #interior QC data
...
real(data=final_brease_p_AC,method="CocoLasso2",Sigmax=Sigma_e2ee,deltax=NULL,name='pbAC') #interior QC data
real(data=final_brease_p_AC,method="CocoLasso3",Sigmax=as.matrix(bdiag(Sigma_e,Sigma_e)),deltax=NULL,name='pbAC')   #study 1
real(data=final_brease_p_AC,method="CocoLasso4",Sigmax=as.matrix(bdiag(Sigma_e2e,Sigma_e2e)),deltax=NULL,name='pbAC') #interior QC data
...
real(data=final_Colore_p_AC,method="CocoLasso2",Sigmax=Sigma_e2ee,deltax=NULL,name='pcAC') #interior QC data
real(data=final_Colore_p_AC,method="CocoLasso3",Sigmax=as.matrix(bdiag(Sigma_e,Sigma_e)),deltax=NULL,name='pcAC')   #study 1
real(data=final_Colore_p_AC,method="CocoLasso4",Sigmax=as.matrix(bdiag(Sigma_e2e,Sigma_e2e)),deltax=NULL,name='pcAC') #interior QC data
