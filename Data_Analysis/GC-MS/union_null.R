...
com = function(ZZ,stat,name){
File1 = sprintf("%s_%s_%s_0.csv",ZZ,stat,name)
Z = read.csv(File1, header=T)
for (i in 1:19){
  File2 = sprintf("%s_%s_%s_%d.csv",ZZ,stat,name,(5*i))
...
###mean
setwd("/Volumes/Runqiu Wang/Dr.Dai's project/2022Spring_project/real/GCMS/mean/result")
union = function(stat){
  Z_Lasso_b = com(ZZ="Z",stat=stat,name="pbAC")
  Z_Lasso_c = com(ZZ="Z",stat=stat,name="pcAC")
  Ztilde_Lasso_b = com(ZZ="Ztilde",stat=stat,name="pbAC")
  Ztilde_Lasso_c = com(ZZ="Ztilde",stat=stat,name="pcAC")
  ...
  File7=sprintf("sumbeta1_%s.csv",stat)
  File8=sprintf("sumbeta2_%s.csv",stat)
  File9=sprintf("sumbeta3_%s.csv",stat)
  File10=sprintf("sumbeta4_%s.csv",stat)
...
union(stat="Lasso")
union(stat="Lasso1")
union(stat="Lasso_Order")
union(stat="RF")
union(stat="GMUL")
union(stat="GDS")
union(stat="CocoLasso")
union(stat="CocoLasso2")
union(stat="CocoLasso3")
union(stat="CocoLasso4")

###Min
setwd("/Volumes/Runqiu Wang/Dr.Dai's project/2022Spring_project/real/GCMS/min/result2")
union = function(stat){
Z_Lasso_b = com(ZZ="Z",stat=stat,name="pbAC")
Z_Lasso_c = com(ZZ="Z",stat=stat,name="pcAC")
Ztilde_Lasso_b = com(ZZ="Ztilde",stat=stat,name="pbAC")
...
setwd("/Volumes/Runqiu Wang/Dr.Dai's project/2022Spring_project/real/GCMS/Multi/result2")
union1 = function(stat){
  ...
  File7=sprintf("GCMS_MI_union/analytic/sumbeta1_%s.csv",stat)
  File8=sprintf("GCMS_MI_union/analytic/sumbeta2_%s.csv",stat)
  File9=sprintf("GCMS_MI_union/analytic/sumbeta3_%s.csv",stat)
  File10=sprintf("GCMS_MI_union/analytic/sumbeta4_%s.csv",stat)
...
union1(stat="CocoLasso3")
union1(stat="CocoLasso4")
...
union3(stat="CocoLasso3")
union3(stat="CocoLasso4")
