...
final=read.csv("GCMS/Multi/final.csv")
final=final[,-1]

MI = function(method,data) {
  if (method == "Analytic") {
  ...
  File2=sprintf("GCMS/Multi/data_breast_nmr_%s.csv",method)
  write.csv(data2, File2)
  File3=sprintf("GCMS/Multi/data_Colore_nmr_%s.csv",method)
  write.csv(data3, File3)
  File4=sprintf("GCMS/Multi/data_breast_match_nmr_%s.csv",method)
  write.csv(data4, File4)
  File5=sprintf("GCMS/Multi/data_Colore_match_nmr_%s.csv",method)
  write.csv(data5, File5)
}

#MI(method="All",data=final)
#MI(method="AnalyticEY",data=final)
#MI(method="AllEY",data=final)

whole = function(way,data) {
  ...
  File6=sprintf("GCMS/Multi/data_whole_%s.csv",way)
  write.csv(data1, File6)
}
whole(way='mean',data=final)
whole(way='min',data=final)
whole(way='MI',data=final)
whole(way='MIEY',data=final)
