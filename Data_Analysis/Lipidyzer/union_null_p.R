...
read=read.csv("~/Downloads/Result_COCO1/result_newtry2/final_breast_p.csv",header=T)
...
union1 = function(stat){
  Z_Lasso_b = com_multi(ZZ="Z",stat=stat,cancer='breast',name="p")
  Z_Lasso_c = com_multi(ZZ="Z",stat=stat,cancer='Colore',name="p")
  Ztilde_Lasso_b = com_multi(ZZ="Ztilde",stat=stat,cancer='breast',name="p")
  Ztilde_Lasso_c = com_multi(ZZ="Ztilde",stat=stat,cancer='Colore',name="p")
  ...
  File7=sprintf("analytic_p/sumbeta1_%s.csv",stat)
  File8=sprintf("analytic_p/sumbeta2_%s.csv",stat)
  File9=sprintf("analytic_p/sumbeta3_%s.csv",stat)
  File10=sprintf("analytic_p/sumbeta4_%s.csv",stat)
