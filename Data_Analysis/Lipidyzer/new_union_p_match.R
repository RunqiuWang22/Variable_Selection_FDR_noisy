...
whole = function(ZZ,stat,cancer,name){
  ...
  Z=NULL
  for (i in 1:20){
    File2 = sprintf("%s_%s_%s_match_Analytic_%s_%d.csv",ZZ,stat,cancer,name,i)
...
new.null <- function(stat,name){
  ZmatW_b = whole(ZZ="Z",stat=stat,cancer="breast",name=name)
  ZtildematW_b= whole(ZZ="Ztilde",stat=stat,cancer="breast",name=name)
  ZmatW_c = whole(ZZ="Z",stat=stat,cancer="Colore",name=name)
  ZtildematW_c= whole(ZZ="Ztilde",stat=stat,cancer="Colore",name=name)
  p=dim(ZmatW_b)[2]
  rep=dim(ZmatW_b)[1]
...
write.csv(result_breast_p,"result_union_p_match.csv")
...
write.csv(result_breast_aq,"result_union_aq_match.csv")
