...
whole = function(ZZ,stat,cancer,name){
  ...
  File1 = sprintf("~/Downloads/Result_COCO1/result_newtry2/final_breast_%s.csv",name)
  ...
  Z=NULL
  for (i in 1:20){
    File2 = sprintf("%s_%s_%s_match_Analytic_%s_%d.csv",ZZ,stat,cancer,name,i) ###change match or all control here
...
#xx=whole(ZZ="Z",stat="Lasso",cancer="breast",name="p")
...
Lasso = new(stat="Lasso",name="p",cancer="breast")$sumselect1[,2]
Lasso_Order = new(stat="Lasso_Order",name="p",cancer="breast")$sumselect1[,2]
GMUL = new(stat="GMUL",name="p",cancer="breast")$sumselect1[,2]
GDS = new(stat="GDS",name="p",cancer="breast")$sumselect1[,2]
CocoLasso2 = new(stat="CocoLasso2",name="p",cancer="breast")$sumselect1[,2]
RF = new(stat="RF",name="p",cancer="breast")$sumselect1[,2]
result_breast_p = cbind(Lasso,Lasso_Order,GMUL,GDS,CocoLasso2,RF)
colnames(result_breast_p) = c("Lasso","Lasso_Order","GMUL","GDS", "CocoLasso2","RF")
write.csv(result_breast_p,"result_breast_p_match.csv")

Lasso = new(stat="Lasso",name="aq",cancer="breast")$sumselect1[,2]
Lasso_Order = new(stat="Lasso_Order",name="aq",cancer="breast")$sumselect1[,2]
GMUL = new(stat="GMUL",name="aq",cancer="breast")$sumselect1[,2]
GDS = new(stat="GDS",name="aq",cancer="breast")$sumselect1[,2]
CocoLasso2 = new(stat="CocoLasso2",name="aq",cancer="breast")$sumselect1[,2]
RF = new(stat="RF",name="aq",cancer="breast")$sumselect1[,2]
result_breast_aq = cbind(Lasso,Lasso_Order,GMUL,GDS,CocoLasso2,RF)
colnames(result_breast_aq) = c("Lasso","Lasso_Order","GMUL","GDS", "CocoLasso2","RF")
write.csv(result_breast_aq,"result_breast_aq_match.csv")

Lasso = new(stat="Lasso",name="p",cancer="Colore")$sumselect1[,2]
Lasso_Order = new(stat="Lasso_Order",name="p",cancer="Colore")$sumselect1[,2]
GMUL = new(stat="GMUL",name="p",cancer="Colore")$sumselect1[,2]
GDS = new(stat="GDS",name="p",cancer="Colore")$sumselect1[,2]
CocoLasso2 = new(stat="CocoLasso2",name="p",cancer="Colore")$sumselect1[,2]
RF = new(stat="RF",name="p",cancer="Colore")$sumselect1[,2]
result_Colore_p = cbind(Lasso,Lasso_Order,GMUL,GDS,CocoLasso2,RF)
colnames(result_Colore_p) = c("Lasso","Lasso_Order","GMUL","GDS", "CocoLasso2","RF")
write.csv(result_Colore_p,"result_Colore_p_match.csv")

Lasso = new(stat="Lasso",name="aq",cancer="Colore")$sumselect1[,2]
Lasso_Order = new(stat="Lasso_Order",name="aq",cancer="Colore")$sumselect1[,2]
GMUL = new(stat="GMUL",name="aq",cancer="Colore")$sumselect1[,2]
GDS = new(stat="GDS",name="aq",cancer="Colore")$sumselect1[,2]
CocoLasso2 = new(stat="CocoLasso2",name="aq",cancer="Colore")$sumselect1[,2]
RF = new(stat="RF",name="aq",cancer="Colore")$sumselect1[,2]
result_Colore_aq = cbind(Lasso,Lasso_Order,GMUL,GDS,CocoLasso2,RF)
colnames(result_Colore_aq) = c("Lasso","Lasso_Order","GMUL","GDS", "CocoLasso2","RF")
write.csv(result_Colore_aq,"result_Colore_aq_match.csv")
