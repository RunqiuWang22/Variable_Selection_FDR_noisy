...
final=read.csv("nmr/final_nmr.csv")
final=final[,-1]
...
MI = function(method,data) {
  ...
  File2=sprintf("nmr/MI/data_breast_nmr_%s.csv",method)
  write.csv(data2, File2)
  File3=sprintf("nmr/MI/data_Colore_nmr_%s.csv",method)
  write.csv(data3, File3)
  File4=sprintf("nmr/MI/data_breast_match_nmr_%s.csv",method)
  write.csv(data4, File4)
  File5=sprintf("nmr/MI/data_Colore_match_nmr_%s.csv",method)
...
whole = function(way,data) {
  ...
  File6=sprintf("nmr/MI/data_whole_nmr_%s.csv",way)
