setwd("/Volumes/Runqiu Wang/Dr.Dai's project/2022Spring_project/real/nmr/MI/")

### combine Z and Ztilde
whole = function(ZZ,stat,cancer,name){
  ###read the rowname for multi ### for composition
  read=read.csv("data_breast_nmr_All.csv",header=T)
...
new.null <- function(stat,name){
  #ZmatW_b = whole(ZZ="Z",stat=stat,cancer="pbAC",name=name)
...
write.csv(result_breast_p,"result/result_union_p_match.csv")
