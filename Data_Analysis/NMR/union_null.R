...
setwd("/Users/runqiuwang/Downloads/Dr.Dai's project/2022Spring_project/real/nmr/MI")
read=read.csv("final_breast_nmr.csv",header=T)
...
com_multi = function(ZZ,stat,name){
  ...
  ZZ = matrix(NA, nrow=p, ncol=100)
  for (k in 1:100){
    ZZ[,k] = as.vector(apply(Z[((5*k-4):(5*k)),],2,mean))
  }
...
###mean
setwd("/Users/runqiuwang/Downloads/Dr.Dai's project/2022Spring_project/real/nmr/mean/result")
union = function(stat){
...
###min
setwd("/Users/runqiuwang/Downloads/Dr.Dai's project/2022Spring_project/real/nmr/min/result")
union = function(stat){
Z_Lasso_b = com(ZZ="Z",stat=stat,name="pbAC")
Z_Lasso_c = com(ZZ="Z",stat=stat,name="pcAC")
Ztilde_Lasso_b = com(ZZ="Ztilde",stat=stat,name="pbAC")
...
setwd("/Users/runqiuwang/Downloads/Dr.Dai's project/2022Spring_project/real/nmr/MI/result")
